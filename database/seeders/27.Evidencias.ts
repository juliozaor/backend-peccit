...
export default class extends BaseSeeder {
  public async run() {
    await TblEvidencias.createMany([
      {
        id: 1,
        nombre: 'Copia de las actas de reunión del comité PECCIT, donde conste la investigación interna de los siniestros viales',
        orden: 1,
        formularioId: 1,
        subTipoId: 3,
        periodoId: 1,
      ...
      ,{
        ...
        id: 8,
        nombre: 'Copia del informe presentado trimestralmente por el lider PECCIT al comité sobre la ejecución de los planes y los avances respectos a las metas',
        orden: 1,
        formularioId: 2,
        subTipoId: 3,
        periodoId: 1,
        ...
        id: 9,
        nombre: 'Certificación suscrita por el Contador y Revisor Fiscal (si aplica) de los recursos empleados trimestralmente para el desarrollo del plan anual de trabajo PECCIT, con el detalle de la destinación de los mismos',
        orden: 1,
        formularioId: 2,
        subTipoId: 3,
        periodoId: 1,
        ...
        id: 11,
        nombre: 'Copia del informe mensual presentado por el lider del PECCIT al comité sobre el total de desplazamientos laborales realizados, las multas impuestas por exceso de velocidad, llamados de atención dentro de las instalaciones y las mediciones realizadas',
        orden: 1,
        formularioId: 2,
        subTipoId: 3,
        periodoId: 5,
      ...
      ,{
        ...
        id: 15,
        nombre: 'Informe del lider del PECCIT sobre las acciones correctivas y oportunidades de mejora implementadas conforme a la auditoría realizada desde el año 2021',
        orden: 1,
        formularioId: 2,
        subTipoId: 3,
        periodoId: 3,
      ...
      ,{
        id: 23,
        nombre: 'Copia del informe mensual presentado por el lider del PECCIT al comité sobre el programa de gestión de velocidad y las mediciones realizadas.',
        orden: 1,
        formularioId: 4,
        subTipoId: 3,
        periodoId: 5,
